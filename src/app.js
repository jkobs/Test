...
(function () {
  ...
  function fetchSpeciesForWater(name, lat, lng) {
    ...
    // Source 2: iNaturalist citizen-science observations (widened to 8 km so
    // low-observation areas still return fish; works nationwide, unlike WI DNR).
    var inatUrl = 'https://api.inaturalist.org/v1/observations' +
      '?taxon_id=47178&lat=' + lat + '&lng=' + lng + '&radius=8&per_page=200&order_by=observed_on&verifiable=true';
