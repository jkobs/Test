...
(function () {
  ...
  var SPECIES = [
    ...
    { name: 'Crappie',         tempLo: 62, tempHi: 78, pref:  0,
      depth: function(d)       { return d > 1 ? '10–15 ft (suspended)' : '6–12 ft (suspended)'; },
      gear:  function(d, t, s) {
    ...
    { name: 'Yellow Perch',    tempLo: 58, tempHi: 72, pref:  1,
      ...
      gear:  function(d, t, s) {
        ...
        if (t > 72) return 'Go deeper 15–20 ft; dawn and dusk most productive';
    ...
    { name: 'Lake Sturgeon',   tempLo: 55, tempHi: 70, pref:  0,
      ...
      gear:  function(d, t, s) {
        if (t < 50 || t > 78) return 'Deepest holes 20–30 ft, nightcrawler or crayfish; long wait';
    ...
    return '<div class="species-section">' +
      ...
      SPECIES.map(function(sp) {
        ...
        return '<div class="species-row">' +
          ...
          '<div class="species-tip">' + sp.depth(delta) + ' · ' + sp.gear(delta, airTemp, solBoost) + '</div>' +
        '</div>';
      }).join('') +
    '</div>';
  }
