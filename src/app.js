...
(function () {
  ...
  var state = { loc: DEFAULT, days: [], notify: false, range: 7, pressureDelta: null, baroData: null, lastAdv: null, nearbyWaters: [] };
  ...
  function renderNearbyWaters() {
    ...
    el.querySelectorAll('.nearby-chip').forEach(function(chip) {
      chip.onclick = function() {
        state.loc = { name: chip.dataset.name, lat: +chip.dataset.lat, lng: +chip.dataset.lng, tz: state.loc.tz };
